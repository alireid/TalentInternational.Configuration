    ...
    public class AzureTableStorageConfigurationProviderTestsSource
    {
        ...
        public static IEnumerable TestCasesWithPrefix
        {
            get
            {
                ...
                yield return new TestCaseData(new[] { ("TalentInternational.LongLongLongLongLong.ConfigurationKeyV3", @"{""KeyKeyKeyKey"": ""value!value$value^value*value8value<value""}") }, new[] { ("TalentInternational.LongLongLongLongLong.ConfigurationKeyV3:KeyKeyKeyKey", "value!value$value^value*value8value<value") }).SetName("SingleTableWithRealisticNamesWithPrefix");
            }
        }
        ...
        public static IEnumerable TestCasesWithoutPrefix
        {
            get
            {
                ...
                yield return new TestCaseData(new[] { ("TalentInternational.LongLongLongLongLong.ConfigurationKeyV3", @"{""KeyKeyKeyKey"": ""value!value$value^value*value8value<value""}") }, new[] { ("KeyKeyKeyKey", "value!value$value^value*value8value<value") }).SetName("SingleTableWithRealisticNamesNoPrefix");
